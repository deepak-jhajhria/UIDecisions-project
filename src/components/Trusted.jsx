    ...
    return (
        <div className="relative py-10">
            <div className=" container max-w-[1130px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-cols-min auto-rows-auto gap-8 mt-9 sm:mt-14 lg:mt-[71px] max-h-[700px] overflow-hidden scroll-bar-hidden">
