                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 sm:gap-[29px]">
                    ...
                    {madeForSecList.map((item, index) => (
                        <div key={index} className={`flex made-sec-card lg:col-span-2 py-10 sm:py-16 lg:py-[87px] px-7 sm:px-[39px] relative ${index === 0 && "after:top-0 after:right-0 py-12 sm:py-16 lg:!pt-20 lg:!pb-[76px] after:bg-[#FE6C4C]"} ${index === 1 && "lg:!col-span-3 lg:!px-[57px] after:bottom-0 after:right-0 after:bg-[#F7C33D] after:!duration-500"} ${index === 2 && "after:bottom-0 after:right-0 after:bg-[#855AFF]"}`}>
                            ...
                            <img className={`absolute pointer-events-none w-[30%] z-10 ${index === 0 && "-top-1 -right-1 lg:w-[220px] lg:h-[225px]"} ${index === 1 && "lg:w-[270px] lg:h-[258px] bottom-0 right-3"} ${index === 2 && "lg:w-[230px] lg:h-[270px] bottom-0 right-0"}`} src={item.animateImage} alt="animateimage" />
                        </div>
                    ))}
                </div>
            </div>
